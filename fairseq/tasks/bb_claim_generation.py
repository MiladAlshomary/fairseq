...
def load_langpair_dataset(
    ...
    logger.info('Loading user big issues from {}'.format(split))
...
@register_task('bb_claim_generation')
class BBClaimGenerationTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--user-encoder-dropout', type=float, default=0.5,
                            help='the dimensionality of the user vector')
    ...
    def build_generator(self, models, args):
        ...
        if getattr(args, "print_alignment", False):
            seq_gen_cls = BBCGSequenceGeneratorWithAlignment
        else:
            seq_gen_cls = BBCGSequenceGenerator

...
@register_model_architecture('bbcg_bart', 'bbcg_bart')
...
@register_model_architecture('bbcg_bart', 'bart_base')
...
@register_model_architecture('bbcg_bart', 'mbart_large')
def mbart_large_architecture(args):
    args.no_scale_embedding = getattr(args, 'no_scale_embedding', False)
    bart_large_architecture(args)


@register_model_architecture('bbcg_bart', 'mbart_base')
def mbart_base_architecture(args):
    args.no_scale_embedding = getattr(args, 'no_scale_embedding', False)
    bart_base_architecture(args)


@register_model_architecture('bbcg_bart', 'mbart_base_wmt20')
